...
<body>
	...
	<?php
		...
		if(!$conn){
          ...
          $rowNum = "SELECT * FROM post WHERE status='completed'";
          ...
          if(mysqli_num_rows($result) == 0){
            ...
            print("<p>There are Completed Losing Posts: </p>");
